...
- [Chromatic](https://chromatic.com) - Visual regression
...
- [x] Setup Playwright
- [x] Configurar CI/CD no GitHub Actions
- [x] Criar fixtures de dados
- [ ] Implementar 15 testes unitários básicos

### Sprint 2: Componentes & Hooks
- [ ] Testes de componentes UI (KPICard, StatusBadge, DataTable)
- [ ] Testes de hooks (useSupabase, useProfessionals)
- [ ] Testes de utilitários (formatting, dateUtils)
...
- [ ] Testes de seed database

### Sprint 4: E2E - Fluxos Críticos
- [ ] Auth flow (login/logout)
- [ ] Dashboard carregamento
- [ ] Lista de profissionais
- [ ] Filtros e busca

### Sprint 5: E2E Completo
...
- **Visual Regression:** Chromatic, Percy, Happo
- **Performance:** Lighthouse, WebPageTest
- **Monitoring:** Datadog, New Relic, LogRocket

---

**Documento Versão 1.0** | Última atualização: 05 de Abril de 2026
