...
# URGENT — BUG-002 — area-usuario/page.tsx truncado (build falhando)

## Problema

`src/app/(dashboard)/area-usuario/page.tsx` está truncado em 59 linhas (JSX sem fechar). Build do Vercel falha. Substituir pelo arquivo completo abaixo.

---

## Arquivo a substituir

**`src/app/(dashboard)/area-usuario/page.tsx`** — sobrescrever completamente:
...
git checkout -b fix/area-usuario-page
# sobrescrever o arquivo com o conteúdo acima
npx tsc --noEmit && npm run build
git add src/app/\(dashboard\)/area-usuario/page.tsx
git commit -m "fix(BUG-002): reconstruir area-usuario/page.tsx truncado"
git fetch origin && git merge origin/main
gh pr create --title "fix(BUG-002): reconstruir area-usuario/page.tsx truncado" --body "Arquivo estava truncado em 59 linhas com JSX não fechado, causando falha de build no Vercel. Reconstruído completamente mantendo a mesma estrutura e funcionalidade."
```
