...
export function VacationFilters() {
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3">
      ...
      <input
        type="search"
        placeholder="Filtrar por área / cliente..."
        defaultValue={searchParams.get('client_area') ?? ''}
        onChange={(e) => handleChange('client_area', e.target.value)}
        className="rounded-lg border border-gray-300 bg-white py-2 px-3 text-sm text-gray-700 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
      />
