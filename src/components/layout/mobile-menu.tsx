          ...
          {isAdmin && (
            <>
              ...
              <Link
                ...
                onClick={() => setIsOpen(false)}
                aria-current={pathname === '/area-usuario/metricas' ? 'page' : undefined}
                className={`flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm transition-colors ${
              ...
              >
                <span className={pathname === '/area-usuario/metricas' ? 'text-blue-600' : 'text-gray-500'} aria-hidden="true">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              ...
              <Link
                ...
                onClick={() => setIsOpen(false)}
                aria-current={pathname === '/area-usuario/saude-testes' ? 'page' : undefined}
                className={`flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm transition-colors ${
              ...
              >
                <span className={pathname === '/area-usuario/saude-testes' ? 'text-blue-600' : 'text-gray-500'} aria-hidden="true">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
              ...
              {isAdmin && (
                <Link
                  ...
                  onClick={() => setIsOpen(false)}
                  aria-current={pathname === '/area-usuario/gerenciar-usuarios' ? 'page' : undefined}
                  className={`flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm transition-colors ${
                ...
                >
                  <span className={pathname === '/area-usuario/gerenciar-usuarios' ? 'text-blue-600' : 'text-gray-500'} aria-hidden="true">
                    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.038 9.038 0 0 0 5.754-1.676A9.038 9.038 0 0 0 21.75 10.5c0-5.042-4.708-9.135-10.5-9.135S.75 5.457.75 10.5c0 1.747.292 3.429.831 5m15 0a9.01 9.01 0 0 0-15.999-3.12M15 19.128v-.008" />
                    </svg>
                  </span>
              ...
              <Link
                ...
                onClick={() => setIsOpen(false)}
                aria-current={pathname === '/area-usuario/audit-log' ? 'page' : undefined}
                className={`flex items-center gap-2.5 px-3 py-2.5 rounded-lg text-sm transition-colors ${
              ...
              >
                <span className={pathname === '/area-usuario/audit-log' ? 'text-blue-600' : 'text-gray-500'} aria-hidden="true">
                  <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
